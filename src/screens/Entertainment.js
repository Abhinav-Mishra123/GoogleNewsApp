    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                setLatesNews(data.articles.slice(0, 5))
            } catch (error) {
    ...
    return (
        <>
            <FlatList
                ...
                ListHeaderComponent={
                <TouchableOpacity onPress={()=> navigation.navigate("AllEntertainment")} style={styles.topstories}>
                <Text style={styles.topStoriesHeading}>Entertainment</Text>
