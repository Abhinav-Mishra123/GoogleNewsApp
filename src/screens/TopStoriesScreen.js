...
function TopStoriesScreen({ navigation }) {
    ...
    return (
        <>
            <FlatList style={{ flex: 1}}
                ...
                ListHeaderComponent={
                <TouchableOpacity onPress={() => navigation.navigate("AllTopStories")} style={styles.topstories}>
                <Text style={styles.topStoriesHeading}>Top Stories</Text>
