...
function BusinessNews({ navigation }) {
    ...
    return (
        <>
            <FlatList
                ...
                ListHeaderComponent={
                <TouchableOpacity onPress={()=> navigation.navigate("AllBusinessNews")} style={styles.topstories}>
                <Text style={styles.topStoriesHeading}>Business</Text>
